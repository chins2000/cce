...
<body>
	<div class="container">
		<form class="form-horizontal" action="<%=path%>/user/add"
			method="post">
			...
			<div class="form-group">
				...
				<div class="col-xs-9">
					<input placeholder="点击选择角色" class="form-control" id="roleName" type="text" readonly value="" onclick="showMenu();"  />
	...
	<script type="text/javascript">
		...
		function showMenu() {
			...
			$("#menuContent").css({
				...
				top : cityOffset.top + roleNameObj.outerHeight() + "px"
			}).slideDown("fast");

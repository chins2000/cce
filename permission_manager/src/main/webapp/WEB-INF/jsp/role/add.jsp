...
<body>
	<div class="container">
		<form class="form-horizontal" action="<%=path%>/role/add"
			method="post">
			...
			<div class="form-group">
				<div class="col-xs-3">权限:</div>
				<div class="col-xs-9">
					<input placeholder="点击选择权限" class="form-control" id="permissionName" type="text" readonly value="" onclick="showMenu();"  />
	...
	<script type="text/javascript">
		...
		function onCheck(e, treeId, treeNode) {
			...
			permissionNameObj.attr("value", v);
		}

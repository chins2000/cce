	...
	<div class="container">
		<form class="form-horizontal" action="<%=path%>/menu/add"
			...
			<div class="form-group">
				...
				<div class="col-xs-9">
					<input placeholder="点击选择上级菜单" class="form-control" id="menuName" type="text" readonly value="${arg_parent_menu_name }" onclick="showMenu_m();"  />
					<input id="menuId" type="hidden" name="pid" value="${arg_parent_menu_id }" />
				</div>
			</div>
			<div class="form-group">
				<div class="col-xs-3">所需权限:</div>
				<div class="col-xs-9">
					<input placeholder="点击选择权限" class="form-control" id="permissionName" type="text" readonly value="${arg_permission_name }" onclick="showMenu_p();"  />
					<input id="permissionId" type="hidden" name="permissionId" value="${arg_permission_id }" />
				</div>
			</div>
			<div class="form-group">
